 ...
 * Типы ячеек
 */
#define RW_MESH_VTK_CELL_TYPE_NONE			RW_MESH_CELL_TYPE_NONE
#define RW_MESH_VTK_CELL_TYPE_TRIANGLE		RW_MESH_CELL_TYPE_TRIANGLE
#define RW_MESH_VTK_CELL_TYPE_POLYGON		RW_MESH_CELL_TYPE_POLYGON
#define RW_MESH_VTK_CELL_TYPE_QUAD			RW_MESH_CELL_TYPE_QUAD
#define RW_MESH_VTK_CELL_TYPE_TETRA			RW_MESH_CELL_TYPE_TETRA
#define RW_MESH_VTK_CELL_TYPE_VOXEL 		RW_MESH_CELL_TYPE_VOXEL
#define RW_MESH_VTK_CELL_TYPE_HEXAHEDRON	RW_MESH_CELL_TYPE_HEXAHEDRON
#define RW_MESH_VTK_CELL_TYPE_WEDGE			RW_MESH_CELL_TYPE_WEDGE
#define RW_MESH_VTK_CELL_TYPE_PYRAMID		RW_MESH_CELL_TYPE_PYRAMID
